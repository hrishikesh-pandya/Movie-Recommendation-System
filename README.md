...
## About This Project
This is a beginner-level project (read: my first ever attempt at making something functional in Java), so expect sub-optimal code, extra files, and other such messes. If you find any mistakes, just know that I probably forgot to delete them or didn’t know what I was doing at the time.
